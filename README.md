# 🌈 HappyVerse: A Digital Ecosystem for Emotional Well-being & Mindfulness  
...
Unlike single-purpose applications, HappyVerse focuses on **holistic emotional wellness**, allowing users to explore different forms of self-care — from talking to an AI companion to journaling and playing calming games.

🌿 *Designed for awareness, not productivity.*  

---

# 🧩 Modules Overview  

## 🤖 1. AI Chatbot – HappyBot  
...
## 🎮 2. Mini Games – Mindful Engagement  
...
🔗 https://happy-verse-mini-games.netlify.app/  

---

## 🌿 3. Calm Zone – Mindfulness & Relaxation  
...
## 📔 4. Calm Journal – Mood Tracking System  
...
🔗 https://happy-verse-calm-journal.onrender.com  
...
Dashboard (Central Hub)
     │
     ├── Calm Zone (Internal React Module)
     ├── Mini Games (External App)
     ├── Happy Bot (AI Chat App)
     └── Calm Journal (Flask App)
```
...
```txt
User → Landing Page → Authentication (Clerk)
        ↓
     Dashboard (React)
        ↓
 ┌───────────────┬───────────────┬───────────────┐
...
✨ *“Small digital moments can create real emotional impact.”*  
